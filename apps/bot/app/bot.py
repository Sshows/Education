...
def start_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Открыть калькулятор", web_app=WebAppInfo(url=f"{settings.telegram_mini_app_url}/calculator"))],
        [InlineKeyboardButton(text="Подобрать вуз", web_app=WebAppInfo(url=f"{settings.telegram_mini_app_url}/universities"))],
        [InlineKeyboardButton(text="Спросить AI", web_app=WebAppInfo(url=f"{settings.telegram_mini_app_url}/ai"))],
